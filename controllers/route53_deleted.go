...
func (r *Route53Reconciler) doFinalizerOperationsForRoute53(instance *cachev1alpha1.Route53) error {
	...
	exist, _, _, _, err := checkAWS.RetrieveRecordOnR53(*r.AWS, instance.Spec.Domain, instance.Spec.RecordType)
	if err != nil {
	...
	if exist {
		...
		err = checkAWS.DeleteRecord(*r.AWS, instance.Spec.Domain, instance.Spec.RecordType, instance.Spec.Value)
		if err != nil {
